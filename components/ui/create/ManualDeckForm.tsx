    ...
    <div className="mt-10 space-y-8">
      ...
      <div>
        ...
        <input
          ...
          className="mt-2 w-full rounded-xl border border-white/10 bg-white/5 px-4 py-3 outline-none transition focus:border-emerald-400"
        />
