...
export default function PrimaryButton({ href, children}: Props) {
    ...
    return (
        <Link   href={href}
                className="group relative overflow-hidden rounded-2xl bg-emerald-500 px-8 py-4 font-semibold text-black transition-all duration-300 hover:scale-105 hover:shadow-[0_0_40px_rgba(16, 185, 129, 0.4)] active:scale-95"
        >
