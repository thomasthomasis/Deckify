    ...
    return (
        ...
        <section className="reounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
                ...
                <Link href="#edit-profile" className="inline-flex items-center justify-center rounded-xl border border-white/10 bg-white/5 px-5 py-3 font-semibold transition hover:border-emerald-400 hover:bg-white/10">
                    Edit Profile
                </Link>
