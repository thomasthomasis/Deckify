...
export default function GeneratePage(){
    ...
    async function generateCards() {
        ...
        if (notes.trim().length < 100) {
            alert("Please enter more study material. Add at least a paragraph of notes.");
            return;
        }
        ...
        if(!data.flashcards) {
            alert("No flashcards were generated.")
            return;
        }
    ...
    return (
        ...
        <div className="mx-auto max-w-3xl p-8">
            ...
            <p className="mt-3 text-zinc-400">
                Paste your own notes and let AI create your flashcards.
            </p>

            <input className="mt-6 w-full rounded-xl border border-zinc-800 bg-zinc-900 p-4"
                placeholder="Deck name..."
                value={deckName}
                onChange={(e) => setDeckName(e.target.value)}
            />

            <textarea className="mt-8 h-64 w-full rounded-2xl border border-zinc-800 bg-zinc-900 p-6"
