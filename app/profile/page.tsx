    ...
    <main className="min-h-screen bg-zinc-950 px-6 py-20 text-white">
      ...
      <div className="mx-auto max-w-4xl">
        ...
        <div className="mt-8 space-y-8">
            ...
            <ProfileStats current_streak={stats?.current_streak} longest_streak={stats?.longest_streak} xp={stats?.xp} level={stats?.level} total_cards_reviewed={stats?.total_cards_reviewed} total_study_time={stats?.total_study_time} />
            ...
            >
                ...
                Manage security, data and account actions.
                </p>
